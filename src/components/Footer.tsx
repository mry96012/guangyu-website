      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1 space-y-5">
            ...
            <p className="text-xs font-sans leading-relaxed" style={{ color: "rgba(245,240,232,0.42)" }}>
            ...
            <div className="flex items-center gap-3">
              <a href={LINE_URL} target="_blank" rel="noopener noreferrer"
                ...
                style={{ background: "rgba(6,199,85,0.12)", border: "1px solid rgba(6,199,85,0.28)" }}
                aria-label="LINE">
          ...
          <div className="space-y-4">
            <h4 className="text-xs tracking-[0.25em] font-sans uppercase font-semibold" style={{ color: "rgba(245,240,232,0.7)" }}>快速連結</h4>
            <ul className="space-y-2.5">
              {quickLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="link-hover text-sm font-sans tracking-wide transition-colors duration-200" style={{ color: "rgba(245,240,232,0.42)" }}>
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Services */}
          <div className="space-y-4">
            <h4 className="text-xs tracking-[0.25em] font-sans uppercase font-semibold" style={{ color: "rgba(245,240,232,0.7)" }}>服務項目</h4>
            <ul className="space-y-2.5">
              {serviceLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="link-hover text-sm font-sans tracking-wide transition-colors duration-200" style={{ color: "rgba(245,240,232,0.42)" }}>
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="text-xs tracking-[0.25em] font-sans uppercase font-semibold" style={{ color: "rgba(245,240,232,0.7)" }}>聯絡我們</h4>
              ...
              {[
                ...
                <li key={c.label} className="flex items-start gap-2">
                  ...
                  {c.href ? (
                    ...
                    <p className="text-xs font-sans" style={{ color: "rgba(245,240,232,0.48)" }}>{c.value}</p>
                  )}
                </li>
              ))}
            </ul>
        ...
        <div className="mt-12 pt-6 flex flex-col md:flex-row justify-between items-center gap-3"
          ...
          <Link href="/privacy" className="link-hover text-xs font-sans transition-colors duration-200" style={{ color: "rgba(245,240,232,0.28)" }}>
            隱私權與個資政策
          </Link>
        </div>
      </div>
