  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center space-y-6">
        ...
        <h2 className="font-serif text-3xl md:text-4xl font-semibold text-cream leading-snug tracking-wide">
          想更清楚地理解自己目前的狀態嗎？
        </h2>
        <p className="text-cream/60 font-sans text-sm md:text-base leading-relaxed max-w-lg mx-auto">
          從理解自己開始，整理下一步方向。<br />
          觀察 · 整理 · 釐清 · 前行
        </p>

        <div className="gold-divider max-w-xs mx-auto">
          <span className="text-gold/50 text-xs tracking-widest">光宇方向命理研究所</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
          ...
          <a href="/bazi" className="btn-outline text-sm">
            先從免費體驗開始 →
          </a>
        </div>

        <p className="text-cream/30 text-xs font-sans">
          LINE ID：@enlite731 ・ 週一至週日 10:00–20:00
        </p>
      </div>
    </section>
  );
