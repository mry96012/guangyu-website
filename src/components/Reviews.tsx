  ...
  return (
    <section className="py-20 section-light">
      <div className="max-w-6xl mx-auto px-6">
                ...
                {[128, 0, 0, 0, 0].map((count, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <div className="flex-1 h-1" style={{ background: "rgba(237,232,224,0.07)", borderRadius: "2px" }}>
                      <div
                        className="h-full"
                        style={{ width: i === 0 ? "100%" : "0%", background: "#C9A96A", borderRadius: "2px" }}
                      />
                    </div>
            ...
            {googleReviews.map((r) => (
              <StaggerItem key={r.name} direction="up">
                ...
                >
                  ...
                  <div className="flex items-center gap-2 pt-2" style={{ borderTop: "1px solid rgba(237,232,224,0.06)" }}>
                    <div
        ...
        {/* LINE Testimonials: stagger fade (direction="none") */}
        <div className="mt-10">
          <AnimateIn direction="none">
