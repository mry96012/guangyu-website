...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        {/* Text */}
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
            <a href={LINE_URL} target="_blank" rel="noopener noreferrer"
              className="btn-gold pulse-gold text-sm">
          ...
          <div className="flex flex-wrap gap-3 justify-center lg:justify-start pt-2">
            {["專業命理分析","隱私保護","書面報告","溫暖陪伴"].map((t) => (
              <span key={t}
                className="flex items-center gap-1.5 text-xs text-cream/60 font-sans tracking-wider"
              >
        ...
        <div className="flex justify-center lg:justify-end relative">
          <div className="relative w-72 h-72 sm:w-96 sm:h-96 lg:w-[440px] lg:h-[440px]">
            ...
            {/* Center fixed overlay */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="text-center">
                <p className="text-gold font-serif text-2xl font-semibold tracking-widest" style={{ textShadow: "0 0 20px rgba(200,166,58,0.5)" }}>
                  光宇
                </p>
