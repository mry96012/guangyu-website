      ...
      <main>
        ...
        <section className="pt-32 pb-16 text-center relative overflow-hidden"
          ...
          <div className="absolute inset-0 pointer-events-none"
            style={{ background: "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(225,174,20,0.08) 0%, transparent 60%)" }} />
          <div className="relative max-w-2xl mx-auto px-6 space-y-4">
            <p className="text-xs tracking-widest font-sans font-semibold" style={{ color: "#E1AE14", letterSpacing: "0.22em" }}>FREE EXPERIENCE</p>
            <h1 className="font-serif text-4xl md:text-5xl font-semibold tracking-wide" style={{ color: "#F5F0E8" }}>免費命盤體驗</h1>
            ...
            <p className="font-sans text-base leading-relaxed" style={{ color: "rgba(245,240,232,0.52)" }}>
              ...
              <span className="text-sm" style={{ color: "rgba(245,240,232,0.3)" }}>完全免費・無需付費・不需要帳號</span>
            </p>
          </div>
        </section>
        ...
        <section className="py-14 section-alt">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="font-serif text-2xl font-semibold text-center mb-8" style={{ color: "#F5F0E8", letterSpacing: "0.04em" }}>免費體驗包含什麼？</h2>
              ...
              {outputs.map((item) => (
                <div key={item.label} className="p-5 text-center space-y-2"
                  ...
                  <div className="w-10 h-10 flex items-center justify-center mx-auto"
                    style={{ background: "rgba(225,174,20,0.07)", border: "1px solid rgba(225,174,20,0.2)" }}>
                    <span className="font-serif text-sm font-semibold" style={{ color: "#E1AE14" }}>{item.char}</span>
                  </div>
                  <p className="font-sans text-xs font-semibold" style={{ color: "#E1AE14" }}>{item.label}</p>
                  <p className="font-sans text-xs leading-relaxed" style={{ color: "rgba(245,240,232,0.45)" }}>{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 section-light">
          <div className="max-w-2xl mx-auto px-6">
            <div className="text-center mb-8 space-y-2">
              <h2 className="font-serif text-2xl font-semibold" style={{ color: "#F5F0E8", letterSpacing: "0.04em" }}>輸入你的出生資料</h2>
              <p className="font-sans text-sm" style={{ color: "rgba(245,240,232,0.42)" }}>時間越精準，分析越準確；不知道出生時間也沒關係</p>
            </div>
        ...
        {submitted && result && (
          <section className="py-16 section-alt">
            <div className="max-w-3xl mx-auto px-6 space-y-6">
              ...
              {/* Year pillar – FREE */}
              <div className="p-6"
                style={{ background: "#1A1A1A", border: "1px solid rgba(225,174,20,0.25)" }}>
                <div className="flex items-center justify-between mb-4">
                  <p className="text-xs font-sans tracking-widest uppercase" style={{ color: "#E1AE14" }}>年柱 · 日主（基礎版）</p>
                ...
                <div className="mt-4 p-4 text-sm font-sans leading-relaxed space-y-2"
                  ...
                  <p><span style={{ color: "#E1AE14" }}>◆ 年柱解讀：</span>
                    <span style={{ color: "rgba(245,240,232,0.6)" }}>你的年柱為 <strong style={{ color: "#F5F0E8" }}>{result.year.stem}{result.year.branch}</strong>，代表你的先天性格底色與童年環境影響。</span>
                  </p>
                  <p><span style={{ color: "#E1AE14" }}>◆ 日主特質：</span>
                    <span style={{ color: "rgba(245,240,232,0.6)" }}>日主 <strong style={{ color: "#F5F0E8" }}>{result.dayMaster}</strong>（{result.dayMasterElement}性），先天具備{result.dayMasterElement}的核心性格，包含其獨特的思維模式與行事風格。</span>
                  </p>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden"
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {["年柱","月柱","日柱","時柱"].map((p) => (
                      <div key={p} className="text-center p-4" style={{ background: "rgba(245,240,232,0.02)" }}>
                        <p className="text-xs mb-3 font-sans" style={{ color: "rgba(245,240,232,0.2)" }}>{p}</p>
                        <p className="font-serif text-3xl" style={{ color: "rgba(245,240,232,0.15)" }}>甲</p>
                        <p className="font-serif text-3xl mt-1" style={{ color: "rgba(245,240,232,0.15)" }}>子</p>
                        <p className="text-xs mt-2 font-sans" style={{ color: "rgba(245,240,232,0.1)" }}>木</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center"
                  ...
                  <div className="max-w-sm space-y-4">
                    ...
                    <h3 className="font-serif text-xl font-semibold" style={{ color: "#F5F0E8", letterSpacing: "0.04em" }}>取得你的完整命盤</h3>
        ...
        {!submitted && (
          <section className="py-16" style={{ background: "#0D0D0D" }}>
            <div className="max-w-3xl mx-auto px-6 text-center space-y-10">
              <h2 className="font-serif text-2xl font-semibold" style={{ color: "#F5F0E8", letterSpacing: "0.04em" }}>體驗後還可以做什麼？</h2>
                ...
                {[
                  ...
                  <div key={step.n} className="p-6 space-y-3"
                    ...
                    <div className="w-10 h-10 flex items-center justify-center mx-auto font-serif text-sm font-bold"
                      style={{ background: "rgba(225,174,20,0.08)", border: "1px solid rgba(225,174,20,0.2)", color: "#E1AE14" }}>
                      {step.n}
                    </div>
                    <p className="font-serif text-base font-semibold" style={{ color: "#F5F0E8" }}>{step.t}</p>
                    <p className="font-sans text-xs leading-relaxed" style={{ color: "rgba(245,240,232,0.45)" }}>{step.d}</p>
                  </div>
                ))}
              </div>
